...
export default function AcademyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#070909] text-white">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 md:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="rounded bg-[#20d9ff] px-4 py-2 text-sm font-black text-[#031018]"
            >
              Start learning
            </Link>
          </div>
      ...
      <main>
        <section className="border-b border-white/10 bg-[linear-gradient(135deg,#071827_0%,#07090d_60%,#0b1f31_100%)]">
          <div className="mx-auto grid min-h-[68vh] max-w-7xl items-center gap-10 px-4 py-14 md:px-6 lg:grid-cols-[1.15fr_0.85fr]">
            <div>
              <div className="display-face text-sm uppercase tracking-[0.28em] text-[#20d9ff]">
              ...
              <h1 className="display-face mt-5 max-w-4xl text-[clamp(2.8rem,6vw,5.8rem)] uppercase leading-[0.92]">
                ...
                <br />
                <span className="text-[#20d9ff]">From the first step.</span>
              </h1>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/academy/login?mode=signup"
                  className="inline-flex items-center gap-2 rounded bg-[#20d9ff] px-6 py-3 font-black text-[#031018]"
                >
            ...
            <div className="border-l border-[#20d9ff]/30 pl-6 md:pl-10">
              <div className="grid gap-6 sm:grid-cols-3 lg:grid-cols-1">
                {[
                  ...
                  <div key={label}>
                    <div className="display-face text-4xl text-[#20d9ff]">
                      {value}
                    </div>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ...
              return (
                <article
                  key={String(title)}
                  className="border-t-2 border-[#20d9ff] bg-[#0b1420] p-6"
                >
                  <ItemIcon className="text-[#20d9ff]" />
          ...
          <div className="mx-auto max-w-7xl px-4 py-14 md:px-6">
            ...
            <div className="mt-9 grid gap-px overflow-hidden border border-white/10 bg-white/10 lg:grid-cols-2">
              {courseModules.map((module) => (
                <article key={module.number} className="bg-[#09131d] p-6">
                  <div className="text-sm font-bold tracking-[0.25em] text-[#20d9ff]">
